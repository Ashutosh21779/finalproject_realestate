...
public function AgentUpdatePropertyThambnail(Request $request){
    ...
    public function BuyBasicPlan(){

        $id = Auth::user()->id;
        $data = User::find($id);
        return view('agent.package.basic_plan', compact('data'));
    ...
    public function StoreBasicPlan(Request $request){

        $id = Auth::user()->id;

        // Use Eloquent increment method
        User::find($id)->increment('credit', 5); // Increment by 5 for Basic

        $notification = array(
            'message' => 'Basic Plan Activated Successfully (5 Credits Added)',
            'alert-type' => 'success'
        );
    ...
    public function StoreBusinessPlan(Request $request){
        ...
        // Use Eloquent increment method
        User::find($id)->increment('credit', 3); // Increment by 3 for Business
     ...
     public function StoreProfessionalPlan(Request $request){
        ...
        // Use Eloquent increment method
        User::find($id)->increment('credit', 10); // Increment by 10 for Professional
    ...
    public function AgentUpdateSchedule(Request $request){
        ...
        Schedule::findOrFail($sid)->update([
            'status' => '1', // Use '1' for approved to maintain compatibility
    ...
    public function AgentRejectSchedule(Request $request){

        $sid = $request->id;

        Schedule::findOrFail($sid)->update([
            'status' => '2', // Use '2' for rejected to maintain compatibility
        ]);
