...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDm9HkJUgDFFUCBj8U0MhzYVRwoJ0VjWLs&libraries=places" async defer></script>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="text" name="latitude" id="latitude" class="form-control" value="27.7172">
                <small class="text-muted">Default is set to Kathmandu, Nepal</small>
            </div>
        </div><!-- Col -->
        <div class="col-sm-6">
            <div class="mb-3">
                <label class="form-label">Longitude</label>
                <input type="text" name="longitude" id="longitude" class="form-control" value="85.3240">
                <small class="text-muted">Default is set to Kathmandu, Nepal</small>
            </div>
        </div><!-- Col -->
    </div><!-- Row -->
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <button type="button" id="geocode-address" class="btn btn-info">Get Coordinates from Address</button>
            <small class="text-muted ms-2">This will use the address, city, and postal code to find coordinates</small>
        </div>
    </div><!-- Row -->
 ...
 <script>
  ...
  $(document).ready(function(){
   ...
   $('#geocode-address').on('click', function() {
       ...
       var fullAddress = address + ', ' + city + ', ' + postalCode + ', Nepal';

       if (!address || !city) {
           alert('Please enter at least address and city before geocoding');
           return;
       }
