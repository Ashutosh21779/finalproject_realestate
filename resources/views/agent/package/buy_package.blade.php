                    ...
                    <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-grid">
                            <a href="{{ route('buy.basic.plan') }}" class="btn btn-primary mt-4">Start Now</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h1 class="text-center">NPR 20</h1>
                    ...
                    <div class="col-md-4 stretch-card">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h1 class="text-center">NPR 50</h1>
                          <p class="text-muted text-center mb-4 fw-light">Unlimited Months</p>
